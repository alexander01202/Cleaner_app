...
export default function Guarantor({ navigation }) {
    ...
    const [imgInfo, setImageInfo] = useState({fileId:null,fileName:null})
    ...
    const updateDetails = () => {
        fetch(`${AllKeys.ipAddress}/updateGuarantor?accountName=${accountName}&accountNumber=${accountNumber}&bankName=${bankName}&bvn=${bvn}&cleaner_id=${cleaner_id}&img=${img}&fileId=${imgInfo.fileId}&fileName=${imgInfo.fileName}&firstname=${firstname}&lastname=${lastname}&nin=${nin}&number=${number}&address=${address}&relationship=${relationship}`)
    }
    ...
    const pickImage = async () => {
        ...
        const uploadImage = await fetch(`${uploadUrl}`, {
            ...
            headers:{
                ...
                'X-Bz-File-Name':`guarantor/${displayName}${cleaner_id}/${fileName}`,
            ...
            setImage(`https://f004.backblazeb2.com/file/${__DEV__ ? 'blipmooretest' : 'blipmoore'}/guarantor/${displayName}${cleaner_id}/${fileName}`);
    ...
    const deleteImage = async() => {
        ...
        if (req.fileId) {
            fetch(`${AllKeys.ipAddress}/deleteGuarantorImage?cleaner_id=${cleaner_id}&fileId=${imgInfo.fileId}`)
            setUploadingImage(false)
            setImage('')
  ...
  return (
    <SafeAreaView style={styles.container}>
        <BankAccountModal completedBankDetails={completedBankDetails} changeBankModalVisible={changeBankModalVisible} bankModalVisible={bankModalVisible} />
        ...
        <View style={{ marginVertical:10,padding:10 }}>
            ...
            <View style={styles.parentInput}>
                <View style={styles.inputContainerTitle}>
                    <Text style={styles.title}>Guarantor's FirstName</Text>
                </View>
                <Animatable.View>
                    <TextInput 
                        style={styles.input}
            ...
            <View style={styles.parentInput}>
                <View style={styles.inputContainerTitle}>
                    <Text style={styles.title}>Guarantor's LastName</Text>
                </View>
                <Animatable.View>
                    <TextInput 
                        style={styles.input}
            ...
            <View style={styles.parentInput}>
                <View style={styles.inputContainerTitle}>
                    <Text style={styles.title}>Guarantor's NIN</Text>
                </View>
                <Animatable.View>
                    <TextInput 
                        style={styles.input}
            ...
            <View style={styles.parentInput}>
                <View style={styles.inputContainerTitle}>
                    <Text style={styles.title}>Guarantor's Mobile number</Text>
                </View>
                <Animatable.View>
                    <TextInput 
                        style={styles.input}
            ...
            <View style={styles.parentInput}>
                <View style={styles.inputContainerTitle}>
                    <Text style={styles.title}>Guarantor's Home Address</Text>
                </View>
                <Animatable.View>
                    <TextInput 
                        style={styles.input}
            ...
            <View style={styles.parentInput}>
                <View style={styles.inputContainerTitle}>
                    <Text style={styles.title}>Guarantor's Relationship With You</Text>
                </View>
            ...
            <>
                <View style={styles.parentInput}>
                    <View style={styles.inputContainerTitle}>
                        <Text style={styles.title}>Guarantor's BVN</Text>
                    </View>
                    <Animatable.View>
                        <TextInput 
                            style={styles.input}
                ...
                <View style={{ marginVertical:10 }}>
                    <Text style={{ fontFamily:'viga',fontSize:16 }}>Enter Your Guarantor's bank details</Text>
                </View>
                ...
                <View style={{ marginVertical:10 }}>
                    <Text style={{ fontFamily:'viga',fontSize:16 }}>Upload Guarantor's Picture</Text>
                </View>
                    <View style={styles.chooseImageBox}>
                    {
                        uploadingImage
                ...
                
                {
                    ...
                    :
                    firstname && lastname && number && address && relationship && img && img.length > 5
                    ?
